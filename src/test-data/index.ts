...
import { Address, AddressIndexed } from '../modules/addresses/types';
import { Project, ProjectIndexed } from '../modules/projects/types';
...
const companiesIndexed: CompanyIndexed = {
  '1': {
    id: '1',
    name: 'Hackett - Greenfelder',
    business: 'world-class streamline supply-chains',
...
const addressesIndexed: AddressIndexed = {
  '1': {
    id: '1',
    city: 'South Edna',
    country: 'Rwanda',
...
const projectsIndexed: ProjectIndexed = {
  '1': {
    id: '1',
...
const employeesIndexed: EmployeeIndexed = {
  '1': {
    id: '1',
    firstName: 'Fanny',
    lastName: 'Crona',
...
export {
  ...
  companiesIndexed, addressesIndexed, projectsIndexed, employeesIndexed
};
